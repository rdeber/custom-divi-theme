					...
					<li id="sidepanel-follow-links">
						<?php if ( function_exists( 'ADDTOANY_FOLLOW_KIT' ) ) {
						    ADDTOANY_FOLLOW_KIT( array(
						        'buttons' => array(
						            'facebook'  => array( 'id' => 'Remote-Learner-US-Inc-1607948926102685' ),
						            'twitter'   => array( 'id' => 'remotelearner' ),
						            'linkedin_company' => array( 'id' => '1014793' ),
						            'youtube_channel' => array( 'id' => 'UCo9ZV7cPmYpUASE-DnmGfzA' ),
						            'feed' => array( 'id' => '/feed/' ),
						        ),
						    ) );
						} ?>
		...
		<header id="main-header" data-height-onload="<?php echo esc_attr( et_get_option( 'menu_height', '66' ) ); ?>">
			...
			?>
				<div class="logo-container">
					<a class="rl-logo rl-logo-1" href="<?php echo esc_url( home_url( '/' ) ); ?>">
						<img src="/wp-content/themes/rl-divi/images/rl-logo.svg" alt="<?php echo esc_attr( get_bloginfo( 'name' ) ); ?>" />
					</a>
					<a class="rl-logo rl-logo-2" href="<?php echo esc_url( home_url( '/' ) ); ?>">
						<img src="/wp-content/themes/rl-divi/images/rl-logo-2.svg" alt="<?php echo esc_attr( get_bloginfo( 'name' ) ); ?>"  />
					</a>
				</div>
